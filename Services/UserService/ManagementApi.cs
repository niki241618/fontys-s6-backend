...
public class ManagementApi
{
    ...
    public ManagementApi(IMemoryCache memoryCache, IConfiguration configuration)
    {
    ...
    {
        var url = $"https://{domain}/api/{endpoint}";
    ...
    private static void AppendQueryParams(ref string url, Dictionary<string, string> queryParams)
    {
